...
@Configuration
@EntityScan(basePackages = {"com.project.rentcar.domain.entity"})
@EnableJpaRepositories(basePackages = {"com.project.rentcar.domain.repository"})
public class JpaConfig {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.project.rentcar.domain.entity");
